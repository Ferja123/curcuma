      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row">
          <div className="md:w-1/2 bg-stone-200 p-12 flex items-center justify-center">
            <EditableImage id="productDetailsImage" initialSrc={IMAGES.curcumaPrincipal} alt="Frasco de Cúrcuma" className="w-full max-w-md rounded-2xl shadow-lg transform -rotate-3 hover:rotate-0 transition-transform duration-500" />
          </div>
